...
import { passwordChangeSchema, PasswordChangeInput } from "@/types/schemas/auth.schema"
...
export function PasswordChangeForm({ userId, onSuccess }: PasswordChangeFormProps) {
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
      ...
      <Button type="submit" disabled={isPending} className="w-full bg-green-700 hover:bg-green-800 text-white rounded-lg h-10 mt-2">
