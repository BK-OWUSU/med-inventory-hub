...
import AlertWithDialogue from "../alerts/AlertWithDialogue";
...
export default function TableMain<TData, TValue>({columns, data, searchKey, placeholder, columnVisibilityFilter, tableFilterButtonVisible, tableExportButtonVisible, checkBoxVisibility, loading,handleMultipleDelete,handleMultipleToggleStatus, onActionSuccess,meta,globalFilterFn}:TableProps<TData, TValue>) {
        ...
        {searchKey && (        
         ...
         {/* Table Content */}
                          ...
                          <TableHead
                            ...
                            {header.isPlaceholder ? null : (
                                ...
                                <div
                                    ...
                                    ? "flex items-center gap-2 cursor-pointer select-none hover:text-green-300 flex-1" 
                                ...
                                {!isSelect && header.column.getCanResize() && (
                                    ...
                                    {...{
                                        ...
                                        className: `absolute right-0 top-0 h-full w-1 cursor-col-resize select-none touch-none hover:bg-green-500 transition-colors ${
                                        header.column.getIsResizing() ? "bg-green-600 w-1" : "bg-transparent"
                                        }`,
                                    }}
                                    />
                                )}
                        ...
                        return (
                            ...
                            {!isSelect && !isActions && column.getCanFilter() ? (
                                ...
                                <Input
                                    ...
                                    value={(filterValue as string) ?? ""}
                                    onChange={(e) => column.setFilterValue(e.target.value)}
                                    className="h-8 text-xs border bg-white/10 placeholder:text-gray-400 focus-visible:ring-green-400"
                                />
                                )
                            ) : null}
                            </TableHead>
                ...
                <TableBody>
                  {loading ? (
                    ...
                    table.getRowModel().rows.map((row) => (
                        ...
                        className="hover:bg-green-50 z-0 border transition-colors group/row" 
                        >
                        ...
                        return (
                            ...
                            // but must match the hover color (bg-green-50) when the row is hovered.
                            className={cn(
                                `py-3 border bg-white ${isSelect ? "p-1 " : "px-4"} transition-colors`,
                                // Logic: Standard White, but Row Hover overrides White
                                isPinnedRightBodyCell ? 'group-hover/row:bg-green-50 bg-white' : ''
                            )}
                            style={pinningStyles} // Apply sticky CSS
                            >
            ...
            <div className="flex flex-wrap items-center gap-4 lg:gap-8">
                ...
                <select
                    className="h-8 w-20 rounded-md border  text-xs focus:outline-none focus:ring-1 focus:ring-green-500"
